...
class GFPGANMultipleSelfAttentionv2(nn.Module):
    ...
    def __init__(
        ...
        self.conv_body_first = ConvLayer(3, int(channels[f'{first_out_size}']), 1, bias=True, activate=True)
    ...
    def forward(self, x, y, return_latents=False, return_rgb=True, randomize_noise=True, **kwargs):
        ...
        feat2style = self.attn(feat2style)[0:1, :]
        style_code = self.final_linear(feat2style)
