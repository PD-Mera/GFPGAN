...
class GFPGANMultiplev1(nn.Module):
    ...
    def __init__(
        ...
        super(GFPGANMultiplev1, self).__init__()
...
@ARCH_REGISTRY.register()
class FacialComponentMultipleDiscriminator(nn.Module):
    """Facial component (eyes, mouth, noise) discriminator used in GFPGAN.
    """

    def __init__(self):
        super(FacialComponentMultipleDiscriminator, self).__init__()
